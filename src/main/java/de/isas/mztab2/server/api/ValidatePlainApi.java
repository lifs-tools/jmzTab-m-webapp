...
public interface ValidatePlainApi {
    ...
    default ResponseEntity<List<ValidationMessage>> validatePlainMzTabFile(
        ...
        @ExampleProperty(mediaType = "text/plain", value = GCGCMS_EXAMPLE),
        @ExampleProperty(mediaType = "text/tab-separated-values", value = GCGCMS_EXAMPLE)})) @Valid @RequestBody String mztabfile,
            @RequestParam(
                    value = "level",
