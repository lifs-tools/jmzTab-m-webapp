...
This project provides a validator implementation for the mzTab 1.0 standard and for the current draft 1.1 standard.
...
It uses the new reader / writer and validator APIs of https://github.com/nilshoffmann/jmzTab-m[the jmztab 1.1 reference implementation]
